...
class ImgurImage:
    ...
    def __init__(self, client_id: str | None = None, client: httpx.AsyncClient | None = None):
    ...
    async def upload(self, image_url: str) -> UploadResponse:
        ...
        response = await self.client.post("https://api.imgur.com/3/image", data=data, headers=self._header)
