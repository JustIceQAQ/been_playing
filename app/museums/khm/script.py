    ...
    async def fetch_response(self):
        ...
        async with WReqAsyncClient(
            ...
            responses = await asyncio.gather(
                self.sub_get_response(client, current_exhibitions_url),
                self.sub_get_response(client, permanent_exhibitions),
            )
        return responses
...
async def main():
    ...
    await KhmRunner().run(none_cache, none_image_hosting)
